...
public class Bukkit_v1_20 extends Bukkit_v1_19 implements BukkitInterface {
    ...
    public int getColor(Sign sign, boolean isFront) {
        return isFront ? sign.getSide(Side.FRONT).getColor().getColor().asRGB() : sign.getSide(Side.BACK).getColor().getColor().asRGB();
    }

    @Override
    public boolean isGlowing(Sign sign, boolean isFront) {
        return isFront ? sign.getSide(Side.FRONT).isGlowingText() : sign.getSide(Side.BACK).isGlowingText();
    }
    ...
    public String getLine(Sign sign, int line) {
        return line < 4 ? sign.getSide(Side.FRONT).getLine(line) : sign.getSide(Side.BACK).getLine(line - 4);
    }
