...
public class Bukkit_v1_21 extends Bukkit_v1_20 implements BukkitInterface {
    ...
    public Bukkit_v1_21() {
        BlockGroup.CONTAINERS = new HashSet<>(Arrays.asList(
            ...
            Material.ARMOR_STAND, Material.ITEM_FRAME, Material.SHULKER_BOX, Material.BLACK_SHULKER_BOX,
            ...
            Material.LIGHT_GRAY_SHULKER_BOX, Material.WHITE_SHULKER_BOX, Material.YELLOW_SHULKER_BOX,
            Material.BARREL, Material.BLAST_FURNACE, Material.SMOKER, Material.LECTERN,
            Material.CHISELED_BOOKSHELF, Material.DECORATED_POT, Material.CRAFTER
        ));
        ...
        BlockGroup.INTERACT_BLOCKS = new HashSet<>(Arrays.asList(
            ...
            Material.GRINDSTONE, Material.LOOM, Material.SMOKER, Material.CRAFTING_TABLE,
            Material.CARTOGRAPHY_TABLE, Material.ENCHANTING_TABLE, Material.SMITHING_TABLE,
            Material.STONECUTTER, Material.CRIMSON_FENCE_GATE, Material.WARPED_FENCE_GATE,
        ...
        BlockGroup.UPDATE_STATE = new HashSet<>(Arrays.asList(
            ...
            Material.CRYING_OBSIDIAN, Material.TARGET, Material.SMALL_AMETHYST_BUD, Material.MEDIUM_AMETHYST_BUD,
            Material.LARGE_AMETHYST_BUD, Material.AMETHYST_CLUSTER, Material.CAVE_VINES,
            Material.CAVE_VINES_PLANT, Material.GLOW_LICHEN, Material.LIGHT, Material.LAVA_CAULDRON,
            Material.CHISELED_BOOKSHELF, Material.CRAFTER
        ));
